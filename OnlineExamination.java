...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: What is size of float and double in java?");  
            jb[0].setText("32 and 64");jb[1].setText("32 and 32");jb[2].setText("64 and 64");jb[3].setText("64 and 32");   
        }  
        if(current==1)  
        {  
            l.setText("Que2: Select valid statment to declare and intialize an array?");  
        ...
        {  
            ...
            jb[0].setText("object referance");jb[1].setText("object");jb[2].setText("primitive data type");jb[3].setText("none");  
        }  
        if(current==3)  
        {  
